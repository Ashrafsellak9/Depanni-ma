...
export default function VerifyOtpScreen(): ReactElement {
  ...
  if (!pendingPhone) {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>Aucune inscription en cours.</Text>
        <Button mode="contained" onPress={() => router.replace("/(auth)/register" as never)}>
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Vérification SMS</Text>
      <Text style={styles.subtitle}>Code envoyé au {pendingPhone}</Text>
      ...
      <TouchableOpacity onPress={() => void onResend()} disabled={!canResend || resending}>
