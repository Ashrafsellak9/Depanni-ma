import type { JobStatus, JobUrgency, MissionStatus, OfferStatus } from "@depanni/types";
...
export interface ArtisanProfile {
  ...
  badgeTop: boolean;
  wallet?: { balance: number; currency: string; walletId: string } | null;
  stats: {
  ...
  user?: { email: string; phone: string; locale: string };
}
